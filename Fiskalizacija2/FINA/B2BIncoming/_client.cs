...
namespace WpfCSCS.Fiskalizacija2.FINA.B2BIncoming
{
    ...
    {
        public static FinaInvoiceB2BPortTypeClient GetFinaInvoiceB2BPortTypeClient(string endpointUrl, string dnsIdentity, string serviceCertificatePath, string clientCertificatePath, string clientCertificatePassword)
        {
            ...
            FinaCustomBinding B2BCustomBinding = new FinaCustomBinding();
            CustomBinding binding = B2BCustomBinding.GetB2BCustomBinding();

            //Web service client
            FinaInvoiceB2BPortTypeClient client = new FinaInvoiceB2BPortTypeClient(binding, endpointAddress);
